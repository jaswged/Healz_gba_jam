...
impl<'obj> Frame<'obj> {
    pub fn new(object: &'obj OamManaged<'_>) -> Self {
        let top_left = object.object_sprite(TOP_LEFT.sprite(0));
        let top_right = object.object_sprite(TOP_RIGHT.sprite(0));
        let bot_left = object.object_sprite(BOT_LEFT.sprite(0));
        let bot_right = object.object_sprite(BOT_RIGHT.sprite(0));
