...
use agb::{display::object::{Object, OamManaged}, println};
...
static HP_SPRITE_ARR: [&Sprite; 16] = [
    HP_16_SPRITE,
    HP_15_SPRITE,
    HP_14_SPRITE,
    HP_13_SPRITE,
...
impl<'obj> BossHealthBar<'obj> {
    ...
    pub fn new(object: &'obj OamManaged<'obj>, start_x: i32, start_y: i32) -> Self {
        ...
        let health_end = object.object_sprite(HP_2_SPRITE);
    ...
    pub fn update_bar(&mut self, new_health: usize) {
        ...
        match (self.health_amt, new_health) {
            ...
            _ => {
                println!("Unexpected edge case of health ranges. Too much dps!");
            }
        };
